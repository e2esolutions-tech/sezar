...
//! [`sezar_core::AgilityLevel`] (`Negotiated` / `Configurable` /
...
/// events.
pub const SOURCE_MODULE: &str = "sezar-agility";
...
pub const SCANNER_VERSION: &str = concat!("sezar-agility/", env!("CARGO_PKG_VERSION"));
