//! `sezar-qkd-replay` — drive a running KME emulator through a replay scenario.
//!
//! Reads a scenario file, validates it, and posts each timed
//! [`ControlOp`](sezar_qkd::emulator::ControlOp) to the emulator's
...
use clap::Parser;
use reqwest::Client;
use sezar_qkd::replay::ReplayScenario;
use tracing::{info, warn};
use tracing_subscriber::EnvFilter;

#[derive(Parser, Debug)]
#[command(name = "sezar-qkd-replay", author, version, about)]
struct Args {
