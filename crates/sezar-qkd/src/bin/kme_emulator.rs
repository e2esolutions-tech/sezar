//! `sezar-qkd-kme-emulator` — ETSI GS QKD 014 V1.1.1 reference KME.
//!
...
//! - `POST /control`  (Sezar extension — replay driver)
//!
//! Example:
//!
//! ```bash
//! sezar-qkd-kme-emulator \
...
use clap::Parser;
use sezar_qkd::emulator::{router, EmulatorConfig, EmulatorState};
use tokio::sync::RwLock;
use tracing::info;
use tracing_subscriber::EnvFilter;

#[derive(Parser, Debug)]
#[command(name = "sezar-qkd-kme-emulator", author, version, about)]
struct Args {
