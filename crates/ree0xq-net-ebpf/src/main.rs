//! ree0xQ — kernel-side eBPF program.
//!
...
//! TCP 4-tuple. The userspace loader (`ree0xq-net live-iface`,
...
//! ```
//!
//! Resulting object: `target/bpfel-unknown-none/release/ree0xq-net-ebpf`.
...
#[classifier]
pub fn ree0xq_net_tc(ctx: TcContext) -> i32 {
