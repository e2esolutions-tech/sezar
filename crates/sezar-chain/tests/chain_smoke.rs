//! End-to-end smoke for the three V3 sezar-chain backends.
//!
//! Spawns `sezar-server` on an ephemeral port, runs all
...
use sezar_chain::{bitcoin as bc, ethereum as eth, qrl};
...
async fn all_three_chains_round_trip_through_collector() {
    ...
    tokio::task::spawn_blocking(move || {
        let client = reqwest::blocking::Client::builder()
            ...
            .build()
            .unwrap();
        let post = |ev: &sezar_core::CryptoInventoryEvent| {
