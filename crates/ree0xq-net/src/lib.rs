//! `ree0xq-net` — TLS / SSH / IPsec ciphersuite observation.
//!
...
pub const MODULE_NAME: &str = "ree0xq-net";
...
/// the responsibility of `ree0xq-core`.
pub fn build_tls_event(
    ...
    CryptoInventoryEvent {
        ...
        posture: Posture {
            ...
            // `ree0xq-core::rollup` once that lives outside this crate.
            score: 50,
            rationale,
