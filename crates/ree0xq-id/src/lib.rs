//! `ree0xq-id` — HSM / KMS / smart-card inventory (V4).
//!
...
//!   operator runbooks under `docs/ree0xq-id-yubihsm.md`
//!   and `docs/ree0xq-id-smartcard.md`; the
...
pub const MODULE_NAME: &str = "ree0xq-id";
