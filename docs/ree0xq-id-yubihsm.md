# ree0xq-id V4.3 — YubiHSM 2 + smart-card bring-up
...
`ree0xq-id pkcs11-scan` subcommand from SEZ-16 works
...
export REE0XQ_HSM_PIN=0001password

# 4. Run ree0xq-id with the PKCS#11 feature.
...
export REE0XQ_HSM_PIN=123456       # default PIV PIN
